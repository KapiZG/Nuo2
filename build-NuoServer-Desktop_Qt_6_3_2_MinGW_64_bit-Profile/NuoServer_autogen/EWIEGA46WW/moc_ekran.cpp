...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Ekran_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject Ekran::staticMetaObject = { {
    ...
    qt_meta_stringdata_Ekran.offsetsAndSizes,
    qt_meta_data_Ekran,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Ekran_t
